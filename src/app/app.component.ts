...
export class MyApp {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            this.loginSubscription = this.apiService.loggedin$.subscribe(
                user => {
            ...
            this.errorSubscription = this.apiService.errorHappened$.subscribe(
                error => {
    ...
    initWebPush() {
        if (
            ...
            this._messaging.onMessage(payload => {
                ...
                this.onPushNotification(payload.data);
            });
            ...
            push.on('notification', data =>
                this.onPushNotification(data.additionalData)
            );
