...
export class UsersPage {
  ...
  constructor(public navCtrl: NavController, private apiService: ApiService, public events: Events, navParams: NavParams) {

    this.user_type = navParams.data.user_type ? navParams.data.user_type : 'user';
  ...
  orderClients(type) {
    ...
    let params = {keyword: this.keyword, company_id: this.companyFilter, page: this.page, type_order: type};
